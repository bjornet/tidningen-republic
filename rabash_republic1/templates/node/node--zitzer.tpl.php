...
if (isset($content['field_skribent'])) hide($content['field_skribent_temp']);
hide($content['links']);
hide($content['group_fler_texter']);
...
<article class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php
    // bildspel i blogg
    if ($view_mode == 'full' && !$page) {
      print views_embed_view('bildspel_i_nod', 'panel_pane_1', $nid);
    }
   ?>
...
<?php print render($content['group_fler_texter']); ?>