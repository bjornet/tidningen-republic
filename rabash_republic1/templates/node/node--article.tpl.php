...
<article class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="node__wrapper">
    ...
    <div class="node__content">
      ...
      <?php print render($content['field_ingress']); ?>
    ...
    <?php if($view_mode == 'full'): ?>
		<?php # Republic: Björn [Lägg till länk till prenumeration] ?>
		<div class="link-pren" style="float:left;">Stöd oberoende journalistik! <a style="text-decoration: underline;" href="http://tidningenrepublic.se/prenumerera">Prenumerera på Re:public</a></div>
